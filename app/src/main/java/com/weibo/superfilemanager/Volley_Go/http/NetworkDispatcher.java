...
import com.weibo.superfilemanager.Volley_Go.interf.IDelivery;
    ...
    while (true) {
      ...
      try {
        ...
        if (networkResponse.data != null) {
          HttpCallback callback = request.getSuccessInAsyncCallBack();
          if (callback != null) {
            callback.onSuccessInAsync(networkResponse.data);
          }
        }
